...
function left()
{
	if(greencar_x >= 0)
	{
		...
		console.log("Cuando se presione la flecha izquierda,  x = " + greencar_x + " | y = " +greencar_y);
		uploadBackground();
		 uploadgreencar();
	}
}
...
function right()
{
	...
	{
		greencar_x =greencar_x + 10;
		console.log("Cuando se presione la flecha derecha,  x = " + greencar_x + " | y = " +greencar_y);
		uploadBackground();
		uploadgreencar();
   }
}
